...
void VisionLayer::updateBounds( double robot_x, double robot_y, double robot_yaw, 
    ...
    unsigned int mx, my;
    // set value in the layer's own costmap using setCost().
...
void VisionLayer::updateCosts(costmap_2d::Costmap2D &master_grid,
    ...
    // overwrite the previous values of the master costmap to include our marks.
    // do NOT overwrite if the layer's costmap value is NO_INFORMATION.
